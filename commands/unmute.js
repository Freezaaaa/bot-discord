...
module.exports = {
    run: async (message, args) => {
        ...
        const muteRole = message.guild.roles.cache.find(role => role.name === 'Boloss')
    ...
    guildOnly: true,
    help: {
        description: 'Cette commande permet d unmute un utilisteur .',
        syntax: '[nom de la personne a unmute]'
    }
}