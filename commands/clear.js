module.exports = {
    run: async (message, args) => {
        ...
        message.channel.send(`${size - 1} messages clear !`).then(sent => sent.delete({timeout: 5e3}))
    },
    name: 'clear',
    guildOnly: true,
    help: {
        description: 'Cette commande permet de clear de 0 a 100 des channels.',
        syntax: '[nombre de messages a clear]'
    }
}