...
module.exports = {
    run: async (message, args) => {
        ...
        let muteRole = message.guild.roles.cache.find(role => role.name === 'Boloss')
        if (!muteRole) {
    ...
    guildOnly: true,
    help: {
        description: 'Cette commande permet de muter temporairement un membre.',
        syntax: '[nom de la personne a tempmute]'
    }
}